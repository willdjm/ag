...
<p className='text-center text-xs mt-5 max-w-xs w-20'>Preparamento 
físico</p>
</div>
...
<p className='text-center text-xs mt-5 max-w-xs w-20'>Treinamento
funcional</p>
</div>
...
<p className='text-center text-xs mt-5 max-w-xs w-20'>Apoio
técnico</p>
</div>
...
<p className='text-center text-xs mt-5 max-w-xs w-20'>Qualidade
de vida </p>
</div>
...
<p className='text-center text-xs mt-5 max-w-xs w-32'>Acompanhamento 
por aplicativo</p>
</div>
