...
<div id="" className="max-w-6xl md:h-[29rem] mx-auto px-8 lg:px-5 py-10 lg:py-10 flex items-center justify-between">
  <div className="grid md:flex w-full items-center md:justify-between justify-center gap-10">
    <div className="max-w-xs grid items-center justify-center md:gap-10 gap-2 md:w-44">
      ...
      <p className="text-lg text-center">De atividades e muita dedicação</p>
    </div>
    <div className="max-w-xs grid items-center justify-center md:gap-10 gap-2 md:w-44">
      <h2 className="font-extrabold text-5xl text-center">XX</h2>
      <p className="text-lg text-center">Alunos assessorados</p>
    </div>
    <div className="max-w-xs grid items-center justify-center md:gap-10 gap-2 md:w-44">
      <h2 className="font-extrabold text-5xl text-center">XX</h2>
      <p className="text-lg text-center">Provas próprias realizadas</p>
    </div>
    <div className="max-w-xs grid items-center justify-center md:gap-10 gap-2 md:w-44">
      <h2 className="font-extrabold text-5xl text-center">XX</h2>
      <p className="text-lg text-center">Participações em corridas oficiais</p>
    </div>
  </div>
</div>
</section>
