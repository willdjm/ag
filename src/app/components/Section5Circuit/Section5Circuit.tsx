...
<section id="" className="flex justify-center flex-col  items-center">
  <div className='flex flex-col justify-between justify-items-center lg:max-w-6xl w-full lg:py-16 py-5'>
    <div className="grid w-full justify-items-center justify-center items-center">
      <div
        className="flex flex-col items-center lg:justify-center lg:items-center gap-10 w-full lg:mb-0 lg:w-full max-w-3xl px-6">
        <h3 className="lg:text-3xl text-2xl text-blue-500 text-center">Circuito próprio de provas e desafios</h3>
        <p className="text-center lg:text-center mb-5">Veja algumas das provas e desafios promovidos pela Águia
          Assessoria Esportiva:</p>
      </div>
      <div className="grid md:flex lg:justify-center lg:items-center lg:gap-10 gap-5 lg:x-8">

        <button>
          <a className={"flex lg:max-w-lg lg:p-5 lg:px-5 lg:py-4 py-3 px-2 w-64 h-24 items-center justify-center bg-blue-400 shadow-md"
            + (openTab === 1 ? "text-white bg-blueGray-600" : "text-blue-400 bg-blue-400")} onClick={e => {
              e.preventDefault();
              setOpenTab(1);
            }}
            data-toggle="tab"
        ...
        <button>
          <a className={"flex lg:max-w-lg lg:p-5 lg:px-5 lg:py-4 py-3 px-2 w-64 h-24 items-center justify-center bg-blue-400 shadow-md"
            + (openTab === 2 ? "text-white bg-blueGray-600" : "text-blue-400 bg-blue-400")} onClick={e => {
              e.preventDefault();
              setOpenTab(2);
            }}
            data-toggle="tab"
        ...
        <button>
          <a className={"flex lg:max-w-lg lg:p-5 lg:px-5 lg:py-4 py-3 px-2 w-64 h-24 items-center justify-center bg-blue-400 shadow-md"
            + (openTab === 3 ? "text-white bg-blueGray-600" : "text-blue-400 bg-blue-400")} onClick={e => {
              e.preventDefault();
              setOpenTab(3);
            }}
            data-toggle="tab"
